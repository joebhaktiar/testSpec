const tailwindcssAccessibility = require('tailwindcss-accessibility')

module.exports = {
  purge: ['./components/**/*.{js,jsx}', './pages/**/*.{js,jsx}', './templates/**/*.{js,jsx}', './project/**/*.{js,jsx}'],
  presets: [],
  ...
  theme: {
    ...
    boxShadow: {
      default: '0 3px 6px rgba(0, 0, 0, 0.3)',
      md: '0px 6px 8px -3px rgba(0, 0, 0, 0.3)',
      lg:
  ...
  plugins: [tailwindcssAccessibility],
}